...
exports.removeNative = removeNative;
 ...
 */
function save(element, collection) {
  var seneca = this;
 ...
 * @reject {Error} Error generated by Seneca Entity.
 */
function find(where, collection) {
  var seneca = this;
 ...
 * @reject {Error} Error generated by Seneca Entity.
 */
function findOne(where, collection) {
  var seneca = this;
 ...
 * @reject {Error} Error generated by Seneca Entity.
 */
function updateNative(where, opFields, collection) {
  var seneca = this;
 ...
 * @reject {Error} Error generated by Seneca Entity.
 */
function removeNative(where, collection) {
  var seneca = this;
 ...
 * @reject {Error} Error
 */
function remove(where, collection) {
  var seneca = this;
 ...
 * @reject {Error} The error `name` property will be one of the following:
 */
function populate(object, keyString, select, collection) {
  var seneca = this;
