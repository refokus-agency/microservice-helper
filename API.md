...
**Fulfil**: <code>Object</code> - { dataRwa, data }.  
...
* [microservice](#module_microservice)
    ...
    * _inner_
        * [~$pipePromise](#module_microservice..$pipePromise)
            * [new $pipePromise(fnc, state, [critical])](#new_module_microservice..$pipePromise_new)
...
<a name="module_microservice..$pipePromise"></a>

### microservice~$pipePromise
Class representing a custom Promise.

**Kind**: inner class of [<code>microservice</code>](#module_microservice)  
<a name="new_module_microservice..$pipePromise_new"></a>

#### new $pipePromise(fnc, state, [critical])
