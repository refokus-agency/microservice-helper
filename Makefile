...
generate-docs:
	rm -rf docs
	$(JSDOC) -R ./READ.md -c ./jsdoc.json --verbose

generate-md:
	$(JSDOC2MD) lib/*.js > API.md

.PHONY: build clean prerelease test test-db test-microservice test-handler code-style generate-docs generate-md
